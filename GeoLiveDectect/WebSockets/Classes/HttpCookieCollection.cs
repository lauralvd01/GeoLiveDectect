...
namespace System.Web {
    ...
    public sealed class HttpCookieCollection : NameObjectCollectionBase {
        ...
        //private HttpResponse _response;                   //not necessary in yours case, and avoid all stuff of HttpResponse (witch is big)
        ...
        */
        ...
        private void ThrowIfMaxHttpCollectionKeysExceeded() {
            ...
            //if (Count >= AppSettings.MaxHttpCollectionKeys) {         //avoid all AppSettings.cs dependancies.
            if (Count >= Int32.MaxValue)
            {
                ...
                throw new InvalidOperationException(" The maximum number of form, query string, or posted file items has already been read from the request. To change the maximum allowed request collection count from its current value of {0}, change the \"aspnet:MaxHttpCollectionKeys\" setting. See http://go.microsoft.com/fwlink/?LinkId=238386 for more information. ");         // OV: modif car probleme de "internal" avec la dll de Net7.0, et le SR avec les info n'a pas était trouvé, mais on voit que c'est juste pour chercher le texte de l'error (cf traductions possibles)
            }
        }
