...
using GeoRacing.Handlers.WebSocket;
...
namespace GeoRacing.Handlers
{
    ...
    public class Handler : IDisposable
    {
        ...
        private void Send(HandlerMessage message)
        {
            ...
            //OV: saddely with the Net8 Socket.cs, we don't have the Semaphore (SendReady) working, so only the first send is good. hope Net8 socket deal with SendAsync without need semaphore.
            //try
            //{
